"""
Sistema de pedidos HASHIRA
Solo usa: if / elif / else, while, for, y funciones con return.
"""
...
def gestionar_pedido(saldoapagar):
    """
    Pregunta si el cliente desea seguir comprando, cancelar o pagar.
    Devuelve (saldoapagar, terminar) donde terminar=True indica que
    hay que salir del submenú actual.
    """
    while True:
